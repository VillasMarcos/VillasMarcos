...
Além da área de suporte, venho estudando programação e construindo projetos para desenvolver minhas habilidades e evoluir profissionalmente.

---

## 🚀 Sobre mim

- 💼 Suporte de TI na Lar Cooperativa Agroindustrial
- 🎓 Estudante de Análise e Desenvolvimento de Sistemas
- 🐍 Aprendendo Python
- ⚡ Estudando TypeScript e JavaScript
- 🌐 HTML5 e CSS3
- 🖥️ Redes e Infraestrutura de TI
